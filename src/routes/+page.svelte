		...
		<div class="w-full max-w-7xl mx-auto">
							...
							<div class="grid-card blue-on-white">
								<div class="grid-card-top-outer">
									...
									<div class="grid-card-text">
										An assessment will typically be the first step in your child's and family's
							...
							<div class="grid-card blue-on-white">
								<div class="grid-card-top-outer">
									<div class="grid-card-top-inner">
										...
										<h2 class="grid-card-title">Sensory Integration</h2>
									</div>
									<div class="grid-card-text">
										Sensory Integration is a post-graduate field of study that is specific to
										Occupational Therapy.
									</div>
								</div>
								<a href="/services-sensory-int" target="_self" class="grid-card-btn white-on-blue"
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													d="M15,20 C16,17 33,17 33,20Z M15,20 15,33 19,33 19,44 29,44 29,33 33,33 33,20Z " />
												<path fill="None" d="M16,12 C14,0 34,0 32,12" />
												<path d="M16,10 16,12 17.5,12 17.5,10Z M30.5,10 30.5,12 32,12 32,10Z" />
												<circle cx="24" cy="11" r="5" />
											</svg>
										</div>
										<h2 class="grid-card-title">Sensory Diet</h2>
									</div>
									<div class="grid-card-text">
										A personalised activity plan that regulates the sensory input that a child needs
										to stay focused and organised
									</div>
								</div>
								<a href="/services-sensory-diet" target="_self" class="grid-card-btn white-on-blue"
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													d="M4 45c-1 0-2-1-2-1-1-1-1-2-1-3l1-12v-2c1-1 2-1 2-1h3c1 0 1 1 2 1 0 1 1 2 1 3-2-1 0 1 1 2l5-3c1 0 2 0 2 1s0 3-1 3l-5 3h-2l-2-1 1 4c1 0 3-1 4-1h1l6 3c1 0 2 2 1 3 0 1-1 2-2 1l-6-2c-3 1-4 1-5 1-2 1-3 1-4 1zm34.553-32.204c1.932-.518 3.346-2.967 2.311-6.831-.776-2.898-3.485-5.278-5.417-4.76-2.898.776-4.053 4.192-3.277 7.09 1.035 3.864 3.485 5.278 6.383 4.501zM6.564 24.981c1.992.174 4.159-1.644 4.421-4.632s-1.557-5.155-3.549-5.33-4.159 1.644-4.421 4.632 1.557 5.155 3.549 5.33zM44 39l-8 1 6-1c2-1 2-2 2-4V20c0-1 0-3-1-4-1 0-2-1-3-1h-4c-1 0-2 1-3 2 0 0-1 1-1 3 4-1-2 2-2 3l-6-4c-1 5-3 4-2 5l6 5h3l3-3v5l-2 4-5 2c-2 1-3 3-3 5 0 3 2 4 4 4h16c1 0 3-1 3-3s-2-4-3-4zM21.945 18.428s-1.991 5.481-2.182 4.499c-2.345-1.582-2.726-3.545-3.108-5.508.791-1.172 1.772-1.363 2.945-.572 0 0 2.154.6 2.345 1.582z" />
											</svg>
										</div>
										<h2 class="grid-card-title">DIR &amp; Floortime</h2>
									</div>
									<div class="grid-card-text">
										Individual sessions to develop essential skills for communication, relationships
										and academic performance
									</div>
								</div>
								<a href="/services-dir-floortime" target="_self" class="grid-card-btn white-on-blue"
							...
							<div class="grid-card blue-on-white">
								<div class="grid-card-top-outer">
									<div class="grid-card-top-inner">
										...
										<h2 class="grid-card-title">Visual Schedules</h2>
									</div>
									<div class="grid-card-text">
										Visual schedules help children understand and follow daily routines or
										sequential activities
									</div>
								</div>
								<a
									href="/services-visual-schedules"
									target="_self"
									...
									<div class="grid-card-top-inner">
										<div>
											<svg
												...
												<path
													fill="#FFFFFF"
													d="M16 28c-.999-1.998-3.657-2-4-2c-2 0-5 2-8 2c-1 0-2-.896-2-2V8c0-1.104 1-2 2-2c3.255 0 6-2 8-2c3 0 4 1.896 4 3v19z" />
												<path
													fill="#FFFFFF"
													d="M16 28c.999-1.998 3.657-2 4-2c2 0 5 2 8 2c1 0 2-.896 2-2V8c0-1.104-1-2-2-2c-3.256 0-6-2-8-2c-3 0-4 1.896-4 3v19z" />
											</svg>
										</div>
										<h2 class="grid-card-title">Social Stories</h2>
									</div>
									<div class="grid-card-text">
										Social stories are personalised tools to help children understand social
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													d="M18,6 11,25 22,22 17,34 25,31 21,44 34,23 26,25 32,15 20,16 27,6" />
											</svg>
										</div>
										<h2 class="grid-card-title">Alert Program</h2>
									</div>
									<div class="grid-card-text">
										Developed by Occupational Therapists to teach children self regulation and to
										support learning, attending and positive behaviour
									</div>
								</div>
								<a href="/services-alert-program" target="_self" class="grid-card-btn white-on-blue"
										...
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													...
													d="M24,48 22,44 Q24,43 26,44Z M18,34 21,32 24,34 27,32 30,34 27,42 Q 24,41 21,42Z M18,31 21,29 24,31 27,29 30,31 30,12 18,12Z M18,10 30,10 30,2 C30,0 18,0 18,2Z" />
											</svg>
										</div>
										<h2 class="grid-card-title">Handwriting</h2>
									</div>
									<div class="grid-card-text">
										Foundational skills to develop legible, fluent and fast handwriting styles for
										success in handwriting
									</div>
								</div>
								<a href="/services-handwriting" target="_self" class="grid-card-btn white-on-blue"
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													stroke-width="1"
													d="M11,7 24,9 38,7 32.5,30.5 14.5,30.5Z M16,43 16,40 32,40 32,43Z M21,30 20,41 28,41 27,30Z" />
												...
												<path
													stroke-width="3"
													fill="none"
													d="M36,7 C46,6 46,18 34,20 M12,7 C2,6 2,18 14,20" />
											</svg>
										</div>
										<h2 class="grid-card-title">Skills Development</h2>
									</div>
									<div class="grid-card-text">
										Teaching children functional skills to become more independent in everyday
										activities
									</div>
								</div>
								<a href="/services-skills-dev" target="_self" class="grid-card-btn white-on-blue"
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													d="M4,15.5 24,4 44,15.5 24,27Z M13,29 C12,37 36,37 35,29Z M13,23 13,30 35,30 35,23 24,29Z M6,17.5 6,28 5,41 9,41 8,28 8,18Z" />
												<circle cx="7" cy="28" r="2.5" />
											</svg>
										</div>
										<h2 class="grid-card-title">School visits</h2>
									</div>
									<div class="grid-card-text">
										Observe children in their classroom setting. Establish communication with the
										child's teachers and educational support staff
									</div>
								</div>
								<a href="/services-school-visits" target="_self" class="grid-card-btn white-on-blue"
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<path
													d="M7,44 15,44 15,28 18,28 18,15 4,15 4,28 7,28Z M4,15 Q11,9 18,15Z" />
												<path
													d="M20,44 26,44 26,38 28,38 28,33 18,33 18,38 20,38Z M18,32 Q23,30 28,32Z" />
												<path
													d="M34,44 40,44 40,33 45,33 41,14 33,14 29,33 34,33Z M41,14 Q37,11 33,14Z" />
												<circle cx="11px" cy="7px" r="4px" />
												<circle cx="37px" cy="7px" r="4px" />
												<circle cx="23px" cy="27px" r="3px" />
											</svg>
										</div>
										<h2 class="grid-card-title">Parent Support</h2>
									</div>
									<div class="grid-card-text">
										Providing the family with equipment and strategies to best support their child,
			...
			<section class="section-wrapper blue-on-white">
				...
				<div class="grid-container bg-white">
							...
							<div class="grid-card gray-on-blue">
								...
								<div class="grid-card-top-outer">
									<div class="grid-card-top-inner">
										...
										<h2 class="grid-card-title">About Occupational Therapy</h2>
									</div>
									<div class="grid-card-text">
								...
								<a href="/about-ot" target="_self" class="grid-card-btn blue-on-white"
							...
							<div class="grid-card gray-on-blue">
								<div class="grid-card-top-outer">
									<div class="grid-card-top-inner">
										...
										<h2 class="grid-card-title">Autism Spectrum Disorder</h2>
									</div>
									<div class="grid-card-text">
										<p><span class="font-bold">From Autism South Africa:</span></p>
										<div class="text-left italic">
											<p>
								...
								<a href="/about-autism" target="_self" class="grid-card-btn blue-on-white"
					...
					<div class="grid-cols-wrapper">
						<div class="grid-2cols">
							<div class="@container grid-card gray-on-blue">
								<div class="section-id" id="about-aac" />
								<div class="grid-card-top-outer">
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 64 64" aria-hidden="true">
												<path
													d="M20 0c1 1 1 2-1 5-1 1-2 3-3 5h0c0 1 0 1 1 0l3-3h0c1 0 2-1 2-1 2-1 3-1 4-2h0c2 0 3 1 3 3 0 0-1 1-2 1l-1 1h-1c-1 1-2 1-2 2h0c-1 0-2 1-2 2h0c-1 0-1 1-2 1h0 1 6 0c5 0 9 4 7 6 0 1-1 1-2 0-2-1-4-2-6-2-1 0-3 0-4 1h0c-1 0-1 0 0 1h1 0 1 0 1 0c2 1 3 1 4 2h0c1 1 2 3 3 4h0c1 3 1 5 0 5-1 1-1 0-2-1-1-3-3-5-5-5h0-2 1c-5 1-7 8-4 11 1 1 2 2 4 2s4-2 5-3h0c1-2 2-3 3-2 2 0-1 5-4 8 0 0-1 1-2 1h0-1-1c-2 1-5 1-7 1h0c-5 0-5 0-8 3 0 0-1 1-2 1 0 1 0 1-1 0-3-2-5-6-5-10h0c0-1 0-1 1-2 2-1 5-4 5-5 0 0 1-2 1-3h0v-1h0v-3c1-2 1-4 2-6h0c2-6 4-11 8-15h0c1-2 3-2 3-2zm39 17c2 1 4 4 5 7h0v4h0l-2 2c-1 0-2 1-2 2-1 0-1 1-1 1-1 0-1 1-1 1v1c0 1-1 2-1 2 0 2 0 5-1 7 0 2-1 4-2 7l-3 6h0l-1 1c-2 4-6 7-6 6-1-1-1-2 1-4 1-1 1-3 2-4h0c0-1 1-2 1-2h0c0-1 0 0-1 0-1 1-3 2-5 3v1h0c-1 0-3 1-3 1-1 1-1 1-2 1h0c-1 0-1-1-2-1 0-1 0-2 1-3h0 1 0l1-1h1c2-1 4-3 5-5h0 1-3 0c-2 1-4 0-6 0h0c-4-1-7-4-5-6 0-1 1-1 2 0h1 0v1h2 0c1 1 2 1 3 1s2 0 3-1h0 1c1 0 0-1 0-1-2 0-3 0-5-1h0c-1 0-2-2-3-3h0-1c-1-2-1-3-2-5h0c0-2 1-3 2-2l1 1c2 4 4 6 8 5 2-1 4-5 4-9h0c-1-3-5-4-8-3-1 1-3 2-4 3h0c0 1-1 2-1 2-1 0-2-1-1-3h0c0-1 0-1 1-2h0c0-1 1-2 2-3h0c3-2 5-3 7-3h0 7c1 0 3 0 4-1h0c2-1 3-2 4-4h0l1 1z" />
											</svg>
										</div>
								...
								<a href="/about-aac" target="_self" class="grid-card-btn blue-on-white"
									>Read more
						...
						<div class="grid-2cols">
							<div class="grid-card gray-on-blue">
									...
									<div class="grid-card-top-inner">
										<div>
											<svg class="grid-card-svg" viewBox="0 0 48 48" aria-hidden="true">
												...
												<circle stroke-width="11" fill="none" cx="24" cy="24" r="14" />
											</svg>
										</div>
										<h2 class="grid-card-title">Attention and Concentration</h2>
									</div>
									<div class="grid-card-text">
										<div class="text-left mb-2">
											<p>
								...
								<a href="/about-attention" target="_self" class="grid-card-btn blue-on-white"
									>Read more
					...
					<div class="grid-cols-wrapper">
						<div class="grid-4cols lg:w-1/3">
							<div class="grid-card blue-on-white">
								...
								<a href="/media-blog" target="_self" class="grid-card-btn white-on-blue"
						...
						<div class="grid-4cols lg:w-1/3">
							<div class="grid-card blue-on-white">
								...
								<a href="/media-reviews" target="_self" class="grid-card-btn white-on-blue"
						...
						<div class="grid-4cols lg:w-1/3">
							<div class="grid-card blue-on-white">
								...
								<a href="/media-privacy" target="_self" class="grid-card-btn white-on-blue"
